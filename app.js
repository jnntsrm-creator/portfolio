...
const SITE_DATA = {
  ...
  profile: {
    ...
    bio: "東京都台東区出身。大学進学の時にやりたいことが一つに絞れなくて、地域の実習も、海外も、研究も、全部にチャレンジ出来そうな地域協働学部に飛び込みました。研究領域は地域ブランド、戦略論、都市計画。好きなことは旅行と早起き。最近は読書と運動にも取り組んでいます。クロワッサンとカフェオレが大好きです。",
    keywords: ["地域ブランド", "海外旅行", "戦略論", "都市計画", "カフェ", "留学"],
  },

  /* ---------- HOME ---------- */
  hero: {
    kicker: "Portfolio of a wandering student",
    lead: "東京から高知へ進学して、地域で学び、高知にとどまらず国外でも学びを積み重ねてきました。これは私が大学4年間で経験してきたことをまとめた記録です。",
    name: "Saito Eika — 2026",
  },

  /* ---------- ABOUT ---------- */
  about: {
    lead: "入学した頃は、まだやりたいことが決まっていませんでした。海外での活動も、地域での実習活動も、研究も、留学も。気になったこと全てチャレンジした私の4年間を1年生から振り返ります。年をクリックすると、その年の記録とWorkが開きます。",
  },
  ...
  timeline: [
    {
      ...
      text: "入学して最初の夏休み、国際協働演習の授業でスイスにあるアルプス山脈の山村・Fusioへ。イタリアや日本の大学生と10日間のサマースクールに参加しました。せっかく来たからと、そのままイタリア・サルディーニャ島を周り、本土・Bariの知人の家に1か月半ホームステイ。その後フランスを周って帰国。夏休みを目一杯満喫しました。春には須崎市のスプリングスクールに参加して、チームで出した防災の提案が市に採択され、12月に地域イベントとして開催されました。",
      activities: [
        "スイス・フジオ村のサマースクールに参加（10日間）。「2040年のフジオ」を村の人に英語で提案",
        "サルディーニャ島を周り、イタリア本土へ。バーリ地方で一か月半のホームステイ",
    ...
    },
    {
      ...
      text: "実習活動と本格的な研究が始まった年。気になったプロジェクト型実習地「地域プロモーション・コミュニティマネジメント実習班」に参加し、えひめ・こうち食べる通信、フリーコーヒー、てくてく高知——たくさんのプロジェクトに参加しました。夏は愛知県半田市のサマースクールに参加した後、タイのフィールドワークを実施。自分たちで企画して、実施、報告して授業を作る「地域協働チャレンジ演習」の枠組みをフル活用しました。",
      activities: [
        "えひめ・こうち食べる通信、フリーコーヒー、てくてく高知などの実習プロジェクトを開始",
        "愛知県半田市のSDGs国際協働演習に参加。ガストロノミーツーリズムを提案",
        "タイ・バンコクとチェンマイで2週間のフィールドワーク",
        "春のスプリングスクールでは台湾・イタリアの学生と須崎の新図書館の防災案を発表",
      ],
    },
    {
      id: "y3", year: "2025", grade: "3年生", stage: "五分咲き",
      title: "実習の成果が見え始める", tag: "HALF BLOOM",
      text: "2年生から続けてきた実習のプロジェクトが形になってきた年。食べる通信ではプロジェクトマネージャーとして、取材や記事・動画の作成をマネジメントしました。その他にもてくてくカード、おむすび屋台「むすび場」、40010プロジェクト。——四万十町をフィールドに、関わるプロジェクトの数も一気に増えました。実習活動、交換留学準備と並行して就職活動も行った、とにかく忙しい一年でした。",
      activities: [
        "食べる通信で取材・記事執筆・動画編集・noteでの発信を担当（ごめんケンカシャモ・米ナスなど）",
        "プロジェクトマネージャーとして、1on1やマニュアル作りでプロジェクトの土台作りとチームマネジメント",
        "窪川高校・四万十高校と計6回のワークショップで「てくてく四万十」27店舗分を作成。お祭りで展示",
        "おむすび屋台「むすび場」を企画。お祭りで120個を完売",
        "四万十町の40010プロジェクトに参加。小学生から大人まで幅広いターゲットへ複数のプロジェクトを実施した。",
    ...
    },
    {
      ...
      text: "てくてく高知のクラウドファンディングを、目標の110%で達成。たくさんの方々にご支援いただき、嬉しい気持ちでいっぱいでした。就職活動では、実習や研究活動で身につけた協働力や課題解決力を評価していただき、グローバルに展開している大手2社から内定をいただきました。そして9月からは、ずっと行きたかったイタリア・サルディーニャ島への交換留学に出発します。",
      activities: [
        "就職活動終了。実習・研究・海外経験が評価され、大手2社から内定",
        "てくてく高知のクラウドファンディングが44万円（達成率110%・支援者55人）で成立",
        "卒業研究として都市計画分野の教授の元へ留学し、ウォーカビリティについて研究に取り組む。",
        "9月からイタリア・サルディーニャ島へ。サマースクールに参加後、卒業まで交換留学",
      ],
    },
    {
      id: "y5", year: "2027", grade: "そして未来へ", stage: "満開、その先へ",
      title: "次の目的地へ", tag: "NEXT JOURNEY",
      text: "地域協働学部で学んだことを持って、社会に出ます。研究テーマだった「地域ブランド」や「都市計画」の知見を活用し、地域社会に貢献できるような仕事をしたいと思っています。",
      activities: [
  ...
  worksList: [
    {
      ...
      gradeIds: ["y1", "y4"], year: "2023", role: "参加学生",
    ...
    },
    {
      ...
      detail: "サマースクールを主催していた大学がサルディーニャ島にあった縁で、そのままイタリアへ。せっかく来たからと、知人の家に1か月半ホームステイさせてもらいました。イタリアは小学生のときにもホームステイした時から愛着がある国。語学力向上のためホストファミリーとイタリア語や英語で会話し小学生の時には知らなかったたくさんのことを吸収しました。ゆったりと過ごしながらも、日本時間にはオンラインで集中講義を受けていました。",
      did: [
        "南部バーリ地方で一か月半のホームステイ",
        "小学生の時には出来なかった一人でのカフェめぐり・ジェラート屋さんめぐり・ショッピングを楽しむ",
    ...
    },
    {
      ...
      place: { label: "SUSAKI", small: true, x: 560, y: 240 },
      description: "須崎市で毎年3月に開かれる国際スプリングスクールに3年連続で参加。",
      detail: "海外の学生と一緒に須崎のまちを歩いて、課題を見つけて、市にプレゼンするプログラム。1回目は「光と音」をテーマにしたフェーズフリーな防災のまちづくりを提案して、それが採択され、12月に「Light up the Life! —須崎に希望の灯をともそう—」というイベントとして実現しました。小中高生と一緒に津波避難場所をキャンドルと光で灯す夜は、忘れられません。2回目は台湾とイタリアの学生とチームを組んで、新しくできる図書館を防災と学びの拠点にする提案を英語で発表しました。3回目は、前年度までとは違い、防災の提案をゲームにすることでどの世代にとっても分かりやすいように提案しました。",
      did: [
        "1回目：「光と音」の防災提案が採択され、小中高生も関わるイベントに",
        "2回目：台湾・イタリアの学生と、新図書館の活用提案を英語で発表",
        "3回目：ゲーム形式で防災の提案を作成。高校生も参加して、より楽しく防災が学べるゲームに",
      ],
      outcome: "自分が考えたイベントが須崎市で形になったことがやりがいになって、毎年関わるきっかけにもなりました。短い期間でも言語の壁があってもそれらを工夫して乗り越える過程で視野の広がりや語学力の向上が実感できました。",
      image: "images/w3.jpg",
    ...
    },
    {
      ...
      detail: "2年生の夏、「ガストロノミーツーリズム」をテーマに愛知県半田市とタイのバンコク、チェンマイを続けて周りました。半田では名古屋外国語大学主催のSDGs国際協働演習に参加して、醸造文化と観光について学び、住民インタビューをもとに観光まちづくりを提案しました。その後、タイバンコクとチェンマイの市場や屋台文化、食文化を体験しながらフィールドワークを実施しました。帰国後は、タイでのフィールドワークで得た知見を反映して半田での提案をブラッシュアップしました。半田での演習参加から提案のブラッシュアップまでの一連の実施内容を「地域協働チャレンジ演習」として自分たちで企画・実施・報告し、最終的には授業として認められ単位をいただきました。",
      did: [
        "半田市のSDGs国際協働演習でガストロノミーツーリズムを提案",
        "愛知県で1週間の演習参加、タイ・バンコクとチェンマイで2週間のフィールドワーク実施",
        "自分たちで企画から報告までやり切り、単位を取得",
      ],
      outcome: "フィールドワークを通して、実際に体験し、多角的な視点から学ぶことの大切さを実感しました。",
      image: "images/w4.jpg",
    ...
    },
    {
      ...
      place: { label: "EHIME / KOCHI", small: true, x: 430, y: 178 },
      description: "食べもの付き情報誌の実習。取材から記事・動画まで担当。",
      detail: "愛媛県と高知県の生産者さんを取材して、記事と食べものをセットで届ける「えひめ・こうち食べる通信」。これまでに大川村のはちきん地鶏、黒潮町のハタペーニョ、梼原町の土佐あかうし、御免町のごめんケンカシャモ、四万十市の米ナス、室戸市の干物——高知のつくり手を訪ねて、インタビュー担当と撮影担当に分かれて取材し、記事執筆から動画編集までひと通りやりました。地域プロモーションコミュニティマネジメント実習班は新興の実習班だったため、プロジェクトマネージャーとして、取材、記事執筆、動画編集、noteやyoutubeの運用をマニュアル化し、今後も継続できる基盤を整えました。チームマネジメントでは数々の失敗と試行錯誤を通して協働の難しさを学び、メンバーとのコミュニケーションツールや伝え方、ネックの解消を通してどれだけストレス無くプロジェクトを進められるか、いかに「関わりたい」と思ってもらえるかを意識してマネジメントを行いました。",
      did: [
        "はちきん地鶏・ハタペーニョ・土佐あかうし・ごめんケンカシャモ・米ナス・干物の生産者を取材",
        "記事執筆・撮影・動画編集を行い、note・You Tubeでの発信",
        "PMとしてタスクやスケジュールをマニュアル化。チームマネジメントでの失敗を通して協働とは何かを学ぶ",
      ],
      outcome: "チームのマネジメント、プロジェクトのマネジメントを通して、協働することの難しさを身をもって学びました。一方で、協働することによって一人では出来ないことも成し遂げることができると知りました。就職活動でも、このプロジェクトを通して培った協調性の高さや相手に伝える能力、問題解決能力などを高く評価していただきました。",
      image: "images/w5.jpg",
    ...
    },
    {
      ...
      place: { label: "JAPAN", sub: "KOCHI", x: 640, y: 344 },
      description: "無料のコーヒーで、通りがかりの人と話す活動。",
      detail: "コーヒーを無料で配ると、知らない人との会話が自然に生まれる——そんな場をつくる活動です。岡山県にある吉備国際大学で学術的な部分を学び、これまでに、大学内外やイベントで複数回実施してきました。来た人との会話、来た人同士の会話から新しいつながりが生まれたことも多々ありました。ここから、四万十町の合わせみそや四万十麦豚を使ったおむすび屋台「むすび場」も生まれて、お祭りや商店街での販売も行いました。",
      did: [
        "高知大学、他大学、商店街、お祭り等で複数回実施",
        "「越境するコミュニティ」として人と人とのつながりを形成",
        "おむすび屋台「むすび場」に発展。お祭りやイベントに出店",
      ],
      outcome: "思わぬところで自分と共通点がある人やノウハウを共有できる人と出会うことができ、普段の生活の中では出会うことのない人との出会いを通して可能性や知見が広がることが、越境するコミュニティの強みだと感じました。地域にもこのような越境するコミュニティがあれば\"やってみたい\"を叶えられ、地域の活性化につながるかもという思いから、四万十町でもビジネスや小中高生への居場所づくりと絡めて活動を継続してきました。",
      image: "images/w6.jpg",
    ...
    },
    {
      ...
      detail: "「人はいるのに、お店に十分なお金が落ちていない」という商店街の課題に対して、お店を一軒ずつ紹介するカードを作って掲示するプロジェクト。四万十町では、窪川高校・四万十高校の生徒にワークショップを開き、27店舗分の「てくてく四万十」カードを作成。町役場とも協働しながら、窪川と大正のお祭りや学園祭等で掲示しました。高知市版の「てくてく高知」では、商店街にある100店舗分のカードを作るためにクラウドファンディングに挑戦。55人の方に支援していただき、目標40万円に対して44万円、達成率110%で成立しました。",
      did: [
        "窪川高校・四万十高校の生徒に対して複数回ワークショップを開催（町役場と協働）",
        "27店舗分の「てくてく四万十」を完成させ、地域のお祭りで展示",
        "「てくてく高知」のクラウドファンディングを企画・実行",
      ],
      outcome: "クラウドファンディング達成率110%（44万円・支援者55人）。活動はいまも続いています。",
      image: "images/w7b.jpg",
      gallery: ["images/w7.jpg", "images/w7a.jpg"],
      tags: ["商店街", "クラウドファンディング", "四万十"], link: "",
    },
    {
      id: "w8", no: "08", title: "STUDY IN ITALY", category: "交換留学",
      gradeIds: ["y4"], year: "2026–2027", role: "交換留学生",
      place: { label: "SARDEGNA", small: true, x: 252, y: 520 },
      description: "9月から卒業まで、イタリア・サルディーニャ島へ交換留学。",
      detail: "小学生の頃にホームステイをしてからずっと好きだったイタリア。大学でもサマースクールやホームステイで縁が続いて、留学するならイタリア！と考えていました。実習中は高知にいる必要があったため4年生まで見送っていましたが、実習、就活を終えて、ようやく行けることになりました。都市計画の先生の元へ留学するので、卒業研究を都市計画の分野で行い、現地調査も兼ねて、来学期から卒業前までサルディーニャ島で過ごします。",
      did: [
  ...
  /* ---------- FUTURE ---------- */
  future: {
    lead: "ここまでご覧いただきありがとうございます。\n\n高知大学に入学した時には、やりたいことは特になく、この学部でどんなことが出来るのかも良く分かっていませんでした。私の同級生には野望があって入学し、カリキュラム内だけでなく、課外活動で大きな成果を上げている人も多くいます。けれども私は、カリキュラムの中で与えられたチャンスを最大限活用して、こんなにもたくさんの貴重な経験をし、学びを深めてきました。そして、これらの経験と学びが就職活動につながり、今後の社会人としての土台を作るのだと強く感じました。\n\nこのポートフォリオを通して、地域協働学部の魅力を感じていただけたら幸いです。",
...
function gradeLabelFor(w) {
  ...
  const all = SITE_DATA.timeline.map(t => t.id);
  const idx = all.map((id, i) => ids.includes(id) ? i : -1).filter(i => i >= 0);
  const gs = idx.map(i => SITE_DATA.timeline[i].grade);
  if (!gs.length) return "";
  if (gs.length === 1) return gs[0];
  /* 連続した学年は「1年生〜3年生」、飛び年は「1年生・4年生」と表記 */
  const contiguous = idx[idx.length - 1] - idx[0] === idx.length - 1;
  return contiguous ? `${gs[0]}〜${gs[gs.length - 1]}` : gs.join("・");
}
...
function renderData() {
  ...
  document.getElementById("future-lead").innerHTML = d.future.lead
    .split("\n").map(s => s.trim()).filter(Boolean)
    .map((s, i) => `<span class="block${i ? " mt-4" : ""}">${s}</span>`).join("");
...
function updatePinMuting() {
  ...
  /* 見出しブロック（02-WORKS〜ピンをクリックの案内）と重なったピンも薄くする */
  const head = document.getElementById("works-head");
  const hr = head ? head.getBoundingClientRect() : null;
  const headOnScreen = hr && hr.bottom > 0 && hr.top < window.innerHeight;

  pins.forEach(pin => {
    let mute = !!closetVisible;
    if (!mute && headOnScreen) {
      const b = pin.getBoundingClientRect();
      mute = b.left < hr.right && b.right > hr.left && b.top < hr.bottom && b.bottom > hr.top;
    }
    pin.classList.toggle("is-muted", mute);
  });
}
