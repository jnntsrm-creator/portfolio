...
const SITE_DATA = {
  ...
  profile: {
    ...
    keywords: ["地域ブランド", "旅行", "戦略論", "都市計画", "カフェ"],
  },
  ...
  timeline: [
    ...
    },
    {
      ...
      text: "てくてく高知のクラウドファンディングを、目標の110%で達成。たくさんの方々にご支援いただき、嬉しい気持ちでいっぱいでした。就職活動では、実習や研究活動で身につけた協働力や課題解決力を評価していただき、大手小売企業と大手損害保険会社から内定をいただきました。そして9月からは、ずっと行きたかったイタリア・サルディーニャ島への交換留学に出発します。",
      activities: [
  ...
  worksList: [
    ...
    },
    {
      ...
      place: { label: "JAPAN", sub: "SUSAKI", x: 640, y: 344 },
  ...
  /* ---------- FUTURE ---------- */
  future: {
    lead: "ここまでご覧いただきありがとうございます。高知大学に入学した時には、やりたいことは特になく、この学部でどんなことが出来るのかも良く分かっていませんでした。私の同級生には野望があって入学し、カリキュラム内だけでなく、課外活動で大きな成果を上げている人も多くいます。けれども私は、カリキュラムの中で与えられたチャンスを最大限活用して、こんなにもたくさんの貴重な経験をし、学びを深めてきました。そして、これらの経験と学びが就職活動につながり、今後の社会人としての土台を作るのだと強く感じました。このポートフォリオを通して、地域協働学部の魅力を感じていただけたら幸いです。",
